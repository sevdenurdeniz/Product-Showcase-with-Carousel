...
oProducts.forEach(function (product, productIndex) {
  var roundedRating = Math.round(product.rating); //ratingi yuvarla

  var maxDescriptionLength = 110; // max karakter
  var descriptionText = product.description;

  if (descriptionText.length > maxDescriptionLength) {
    descriptionText =
      descriptionText.substring(0, maxDescriptionLength) + " ..."; //diziyi belli bi yerde kesip alt dizi oluşturdu substring
  }

  var brandColorClass = "";

  if (product.brand === "Apple") {
    brandColorClass = "brand-apple";
  } else if (product.brand === "Samsung") {
    brandColorClass = "brand-samsung";
  } else if (product.brand === "OPPO") {
    brandColorClass = "brand-oppo";
  } else if (product.brand === "Huawei") {
    brandColorClass = "brand-huawei";
  }
  var formattedPrice = product.price.toLocaleString("en-US"); // fiyatı biçimlendir
  var stockText = "Limited Stock";
  var stockClass = "";
  if (product.stock < 50) {
  ...
  var productHTML = `
          ...
          <div id="carouselExampleControls${productIndex}" class="col-12 col-lg-4 my-3">
          <div class="cerceve">
        <div class="resim">
        <div class="carousel slide" data-ride="carousel">
            ...
            <a class="carousel-control-prev" href="#carouselExampleControls${productIndex}" role="button" data-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next" href="#carouselExampleControls${productIndex}" role="button" data-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="sr-only">Next</span>
            </a>
          </div> </div>
          <div class="baslik my-2">${product.title}</div>
        <div class="rating text-center my-2">
          <div class="stars">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="star">
              <path class="star-outline" d="M12 2l3.09 6.3 6.93.96-5 4.85 1.18 6.88L12 17.37l-6.2 3.52 1.18-6.88-5-4.85 6.93-.96L12 2z"/>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="star">
              <path class="star-outline" d="M12 2l3.09 6.3 6.93.96-5 4.85 1.18 6.88L12 17.37l-6.2 3.52 1.18-6.88-5-4.85 6.93-.96L12 2z"/>
            </svg>
        ...
        <div class="row">
          <div class="col-6">
          <div class="marka"><span class="${brandColorClass}">${
    product.brand
  }</span></div>
          </div>
          <div class="col-6">
  ...
  var stars = document.querySelectorAll(
    `#carouselExampleControls${productIndex} .stars .star`
  );

  for (var i = 0; i < rating.length; i++) {
    //rating kadar yıldız boya
    if (i < rating) {
      stars[i].classList.remove("star-outline");
      stars[i].classList.add("star-filled");
    } else {
      stars[i].classList.remove("star-filled");
      stars[i].classList.add("star-outline");
    }
  }
});
